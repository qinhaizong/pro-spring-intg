...
public class ProgrammaticHeaderEnricher {
    public static void main(String[] args) {
        ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext("classpath:programmatic-header-enricher.xml");
        ...
        System.out.println("received: " + output.receive());
    }
}
